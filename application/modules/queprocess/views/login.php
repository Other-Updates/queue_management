...
<img src="http://demo.f2fsolutions.co.in/queue_management/themes/queue/service/images/login-bg.png"/>
<div class="sample">
<div>
    <div class="modal-dialog">
        <form name="login_form" class="qprocess_popup" id="login_form" action="<?php echo base_url('queprocess/login') ?>" method="post">
