...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Add New Client</h5>
    ...
    <div class="panel-body">
        <?php echo form_open_multipart('superadmin/client/add', 'name="add_client" id="add_client" method="post" class="form-horizontal"'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="text" name="client[user_id]" id="user_id" class="form-control required" value="<?php echo $user_id; ?>" readonly="readonly" placeholder="Enter User ID">
                            ...
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="text" name="client[username]" id="username" class="form-control required" placeholder="Enter Username" maxlength="50">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
                                    <i class="icon-user"></i>
                                </div>
                            ...
                            <div class="form-group has-feedback has-feedback-right">
                                ...
                                <input type="text" name="client[mobile_number]" id="mobile" class="form-control required" placeholder="Enter Mobile Number" maxlength="10">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
                            ...
                            <div class="form-group has-feedback has-feedback-right">
                                ...
                                <input type="text" name="client[company_name]" class="form-control" placeholder="Enter Company Name" maxlength="150">
                                <div class="form-control-feedback">
                            ...
                            <div class="form-group has-feedback">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <a href="javascript:void(0);"><img src="<?php echo $theme_path; ?>/service/images/default_image.png" id="profile" class="imagePreview"></a>
                                    </div>
                                </div>
                                <span class="error_msg"></span>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="text" name="client[firstname]" id="firstname" class="form-control required" placeholder="Enter First Name" maxlength="50">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
                                    <i class="icon-user"></i>
                                </div>
                            ...
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="password" name="client[password]" id="password" class="form-control required" placeholder="Enter Password">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
                                    <i class="icon-lock"></i>
                                </div>
                            ...
                            <div class="form-group has-feedback has-feedback-right">
                                ...
                                <input type="text" name="client[email_address]" id="email" class="form-control required" placeholder="Enter Email Address" maxlength="100">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
                            ...
                            <div class="form-group has-feedback has-feedback-right">
                                ...
                                <input type="text" name="client[address]" class="form-control" placeholder="Enter Address" maxlength="150">
                                <div class="form-control-feedback">
                                    <i class="icon-address-location3"></i>
                                </div>
                            </div>
                            <div class="form-group has-feedback">
                                ...
                                <select name="client[status]" id="status" class="form-control ">
                        ...
                        <div class="col-md-4">
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="text" name="client[lastname]" id="lastname" class="form-control required" placeholder="Enter Last Name" maxlength="50">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
                                    <i class="icon-user"></i>
                                </div>
                            ...
                            <!--                            <div class="form-group has-feedback has-feedback-right">
                                                            ...
                                                            <input type="text" name="client[dob]" id="dob" class="form-control required datepicker" placeholder="Select Date of Birth">
                                                            <span class="error_msg"></span>
                                                            <div class="form-control-feedback">
                            ...
                            <div class="form-group has-feedback has-feedback-right">
                                ...
                                <input type="text" name="client[expire_date]" id="expire_date" class="form-control required " placeholder="Select Expire Date">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
                                    <i class="icon-calendar3"></i>
                                </div>
                            ...
                            <div class="form-group has-feedback">
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <input type="file" name="company_logo" id="company_logo" class="form-control" placeholder="Choose Profile Picture">
                                        <div class="form-control-feedback">
                                            <i class="icon-file-picture"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="javascript:void(0);"><img src="<?php echo $theme_path; ?>/service/images/default_image.png" id="logo" class="logoPreview"></a>
                                    </div>
                                </div>
                                <span class="error_msg"></span>
                            </div>
