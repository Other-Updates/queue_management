...
<style>
    ...
    .counter-screen-font-number{ font-size:110px !important;}
    .table_height_row { height:92%;}

    .table_height { height:85%;}
                            ...
                            <tbody id="">
                                <?php if (!empty($token) && count($token) >= 3) { ?>
                                    <tr class="counterheading">
                                        <td style="text-align:center; font-size:20px !important;">COUNTER NAME</td>
                                        <td style="text-align:center; font-size:20px !important;">TOKEN NUMBER</td>
                                    </tr>
                                    <?php
                ...
                success: function (data) {
                    if (data != 0)
                    {
                        if (data.length > 5) {
                            ...
                            //$(".countertable tr td").css("font-size", "32px");
                        }
                        $('.countertable tbody').empty();
                        var values = '';
                        if (data.length >= 3) {
                            values += '<tr class="counterheading"><td style="text-align:center; font-size:20px !important;">COUNTER NAME</td><td style="text-align:center; font-size:20px !important;">TOKEN NUMBER</td></tr>';
                        }
                        $.each(data, function (key, val) {
                            if (val.counter_name != undefined && val.token_number != undefined) {
                                if (data.length < 3) {
                                    ...
                                    values += '<br/><br/><br/><br/>';
                                    values += '<span style="font-size:45px !important;">' + counter + '</span><br/><br/>';
                                    values += '<span style="font-size:113px !important;">' + val.token_number + '</span>';
                                    values += '</td></tr>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data != 0) {
                        ...
                        option_text += '<div class="addimage" style="width:100%; height:100%;">';
                        if (data.type == "Images") {
                            option_text += '<img src="' + add_data + '"width="100%"  height="92%"/></div>';
                            $('#slideshow').append(option_text);
                        }
                        if (data.type == "Videos") {
