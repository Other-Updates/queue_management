...
$(function() {
    ...
    $("#alpaca-option-tree-connector").alpaca({
        "schemaSource": "../default/service/demo_data/alpaca/optiontree-custom-schema.json",
        "optionsSource": "../default/service/demo_data/alpaca/optiontree-custom-options.json",
        "options": {
            "focus": false
        }
    });
