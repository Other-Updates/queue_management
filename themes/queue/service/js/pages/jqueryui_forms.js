...
$(function() {
    ...
    $(".datepicker-icon").datepicker({
        showOn: "button",
        buttonImage: "service/images/ui/datepicker_trigger.png",
    ...
    $("#ac-remote").autocomplete({
        minLength: 2,
        source: "service/demo_data/jquery_ui/autocomplete.php",
        search: function() {
    ...
    $("#ac-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("service/demo_data/jquery_ui/autocomplete.php", request, function(data, status, xhr) {
                cache[ term ] = data;
                response(data);
            });
        },
